      ...
      <div className="select-files">
        <button
          ...
          className="text-primary-foreground bg-primary hover:bg-primary/90
            focus:ring-4 focus:outline-none focus:ring-ring focus:ring-offset-2
            focus:ring-offset-background font-medium rounded-lg text-sm px-5 py-2.5
      ...
      <div className="create-project">
        <button
          ...
          className="inline-flex items-center justify-center
            ...
            text-foreground rounded-lg group bg-gradient-to-br from-chart-4
            to-chart-5 hover:from-chart-4 hover:to-chart-5
